...
date: '2021-04-04'
slug: publishing-tech-book-part-2
categories: []
tags: 
  - career
keywords:
  ...
  - data science
  - books
summary: "Demystifying how to find a technical book publisher, what they help with, and if you should think about self-publishing."
---

[This is my second post on publishing a technical book. If you're not sure if you should write a book, check out [part 1](https://hookedondata.org/publishing-tech-book-part-1/).]
...
The first step to getting a publisher interested in your book idea is to submit a proposal. Anyone can download a copy of [O’Reilly](https://www.oreilly.com/work-with-us.html) and [Manning’s](https://www.manning.com/write-a-book) proposal forms and submit it to the email provided. I couldn’t find Pearson’s US link, but [here’s the UK one](https://www.pearson.com/uk/information-for-authors.html), which also includes some information on why they turn down proposals. I think it’s pretty rare to have an agent if you’re looking to go with a technical book publisher. But if you’re someone who did, let me know! As mentioned above, in our case Manning reached out to Jacqueline, but we still went through the regular process proposal process. 
...
Check out [part 3](https://hookedondata.org/publishing-tech-book-part-3/) for insight into the writing process and how it feels after the book is published!
