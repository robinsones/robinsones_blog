...
This post gives you a brief overview off my journey with purrr and why I think it's worthwhile learning. I introduce how to use `map()` on a vector and then go through some `purrr` functions for creating functions and modifying lists/vectors. Most are covered in Colin's course, though I added a few I found on the [`purrr` cheatsheet](https://www.rstudio.com/resources/cheatsheets/#purrr). 

## Jump to:
1. [Introduction](#introduction)
2. [A brief introduction to map()](#a-brief-introduction-to-map)
3. [Beyond map()](#beyond-map)
    1. [Creating new functions](#creating-new-functions)
        1. [negate()](#negate)
        2. [partial()](#partial)
        3. [safely() and possibly()](#safely-and-possibly)
        4. [compose()](#compose)
    2. [Modifying and summarizing vectors/lists](#modifying-and-summarizing-vectors/lists)
        1. [keep() and discard()](#keep-and-discard)
        2. [map_if()](#map_if)
        3. [every() and some()](#every-and-some)
